...
![esame_telerilev](https://github.com/user-attachments/assets/c09ad067-c4c7-411c-b9c5-3d7c22d7b2ba)
...
![cortina_diff copia](https://github.com/user-attachments/assets/e772b63d-445a-4215-ba7d-a6ff96794c33)
...
> *Come palette di colore è stata lasciata quella standard di viridis per evidenziare al meglio le differenze tra aree senza piante (blu) e con attività fotosintetica (giallo).  
In entrambe le immagini del 2025 si nota un aumento rispetto al 2019 della superficie in blu nelle aree interessate dai cantieri.*

### Analisi multitemporale
Anche per le due località del Cadore è stata calcolata la **differenza tra i valori di NDVI** del 2019 e quelli del 2025, per creare un'immagine che rappresentasse le variazioni temporali ed evidenziasse meglio cambiamenti nella copertura vegetale.
...
![cadore_diff copia](https://github.com/user-attachments/assets/0e18d48f-e7a8-4efc-a22b-25f3b1ae615b)
...
Nel complesso, nonostante l'estensione delle opere analizzate nello studio sia quindi circoscritta, gli **effetti sul paesaggio** dolomitico e sull'ambiente della Valle del Boite (già fortemente frammentato, urbanizzato e colpito dalla tempesta Vaia del 2018) non sono trascurabili, anche per quanto riguarda la **continuità ecologica** ed un **potenziale incremento del carico turistico** associato al miglioramento della viabilità in un'area già soggetta a fenomeni di over-tourism.  
